...
import style from "./atgc.module.css";
  ...
  return (
    <div ref={svgWrapper} id="bases">
      ...
      xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 180">
        ...
        <g id="Connectors" fill="none" stroke="#fff" strokeMiterlimit="10" strokeWidth="4">
        ...
        <g id="Adenine">
          <text transform="translate(40.42 165.8)" fontSize="22" fill="#fff" fontFamily="MetricHPE-Regular, MetricHPE">
            <tspan letterSpacing="-.01em">A</tspan><tspan x="12.96" y="0">denine</tspan>
          </text>
          <polygon id="baseStrokeA" points="110.02 8.5 40.74 8.5 6.1 68.5 40.74 128.5 110.02 128.5 144.66 68.5 110.02 8.5" fill="none" stroke="#2ad2c9" strokeMiterlimit="10" strokeWidth="4"/>
        ...
        <g id="Thymine">
          <text transform="translate(255.32 165.8)" fontSize="22" fill="#fff" fontFamily="MetricHPE-Regular, MetricHPE">
            T<tspan x="12.47" y="0" letterSpacing="0em">h</tspan><tspan x="23.12" y="0">ymine</tspan>
          </text>
          <polygon id="baseStrokeT" points="327.04 8.5 257.76 8.5 223.12 68.5 257.76 128.5 327.04 128.5 361.68 68.5 327.04 8.5" fill="none" stroke="#ff8d6d" strokeMiterlimit="10" strokeWidth="4"/>
        ...
        <g id="Guanine">
          <text transform="translate(475.36 165.8)" fontSize="22" fill="#fff" fontFamily="MetricHPE-Regular, MetricHPE">
            Guanine
          </text>
          <polygon id="baseStrokeG" points="544.82 8.5 475.53 8.5 440.89 68.5 475.53 128.5 544.82 128.5 579.46 68.5 544.82 8.5" fill="none" stroke="#c6c9ca" strokeMiterlimit="10" strokeWidth="4"/>
        ...
        <g id="Cytosine">
          <text transform="translate(688.09 165.8)" fontSize="22" fill="#fff" fontFamily="MetricHPE-Regular, MetricHPE">
            <tspan letterSpacing="0em">C</tspan><tspan x="11.81" y="0">y</tspan><tspan x="21.82" y="0" letterSpacing="-.01em">t</tspan><tspan x="28.64" y="0">osine</tspan>
          </text>
          <polygon id="baseStrokeC" points="759.26 8.5 689.98 8.5 655.34 68.5 689.98 128.5 759.26 128.5 793.9 68.5 759.26 8.5" fill="none" stroke="#01a982" strokeMiterlimit="10" strokeWidth="4"/>
